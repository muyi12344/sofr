...
M_.endo_names(13) = {'AUX_ENDO_LEAD_103'};
M_.endo_names_tex(13) = {'AUX\_ENDO\_LEAD\_103'};
M_.endo_names_long(13) = {'AUX_ENDO_LEAD_103'};
...
M_.param_names(6) = {'thetaD'};
M_.param_names_tex(6) = {'thetaD'};
M_.param_names_long(6) = {'thetaD'};
M_.param_names(7) = {'thetaC'};
M_.param_names_tex(7) = {'thetaC'};
M_.param_names_long(7) = {'thetaC'};
M_.param_names(8) = {'lambdaD'};
M_.param_names_tex(8) = {'lambdaD'};
M_.param_names_long(8) = {'lambdaD'};
M_.param_names(9) = {'lambdaC'};
M_.param_names_tex(9) = {'lambdaC'};
M_.param_names_long(9) = {'lambdaC'};
M_.param_names(10) = {'xiC'};
M_.param_names_tex(10) = {'xiC'};
M_.param_names_long(10) = {'xiC'};
M_.param_names(11) = {'delta'};
M_.param_names_tex(11) = {'delta'};
M_.param_names_long(11) = {'delta'};
M_.param_names(12) = {'gammaI'};
M_.param_names_tex(12) = {'gammaI'};
M_.param_names_long(12) = {'gammaI'};
M_.param_names(13) = {'Abar'};
M_.param_names_tex(13) = {'Abar'};
M_.param_names_long(13) = {'Abar'};
M_.param_names(14) = {'Bbar'};
M_.param_names_tex(14) = {'Bbar'};
M_.param_names_long(14) = {'Bbar'};
...
M_.aux_vars(1).orig_expr = '(1+rL)*(1-delta)*beta^2/C(1)';
M_ = setup_solvers(M_);
...
M_.nonzero_hessian_eqs = [1 2 3 5 7 8 9 13];
...
M_.mapping.A.eqidx = [7 9 12 ];
M_.mapping.ea.eqidx = [12 ];
M_.mapping.eb.eqidx = [11 ];
...
oo_.steady_state(13)=(1+oo_.steady_state(2))*(1-M_.params(11))*M_.params(2)^2/oo_.steady_state(11);
if M_.exo_nbr > 0
