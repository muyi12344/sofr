...
g1(8,13)=(y(9)-params(7))*T(8)-y(9)*params(6)*T(9);
...
g1(9,14)=(-(params(7)+(-y(8))-y(8)*(-params(6))));
g1(9,15)=(-y(10));
g1(10,8)=1;
g1(10,9)=(-1);
g1(11,11)=(1-params(5))*1/params(2)*getPowerDeriv(T(5),params(5),1);
g1(11,12)=(-1);
g1(12,3)=(-(T(2)*y(15)-y(15)*T(4)*(1-params(9))/y(13)));
g1(12,11)=T(1)*params(5)*1/params(2)*getPowerDeriv(T(5),params(5)-1,1);
g1(12,13)=T(6)*params(5)*T(8)-(y(15)*(1+y(3))*T(9)-y(15)*(1+y(3))*(-(T(4)*(1-params(9))))/(y(13)*y(13)));
g1(12,15)=(-(T(2)*(1+y(3))-(1+y(3))*T(4)*(1-params(9))/y(13)));
g1(13,10)=(-1);
g1(14,3)=(-((-y(10))/((1+y(3))*(1+y(3)))));
g1(14,10)=(-(1/(1+y(3))));
g1(14,11)=1-(1-params(9));
g1(15,7)=1;
g1(15,10)=y(15);
g1(15,11)=(-(T(7)*getPowerDeriv(y(11),params(5),1)));
g1(15,12)=params(2);
g1(15,15)=(-(params(8)-y(10)));
